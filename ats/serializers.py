...
class ProjectSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Project
        depth = 3
        fields = ('url', 'created', 'organization', 'role', 'status', 'open_positions_count',
                  'filled_positions_count', 'applicants')
